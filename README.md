...
EMA sayesinde tek bir "temiz" round kötü geçmişi silemez; sürekli şüpheli davranan istemciler zamanla düşük itibar skoruna sahip olur.

> ⚠️ Krum ve kosinüs tabanlı yöntemler istemcileri birbirleriyle karşılaştırdığından, non-IID veri dağılımında saldırgan zaman zaman "çoğunluğun içinde" kalabilir. Hibrit yöntem bunu kısmen hafifletir ancak 20 turda ~%45 tespit oranında kalabilir.
