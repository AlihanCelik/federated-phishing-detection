...
def main():
    ...
    for i in range(1, 3):
        ...
        client_process = subprocess.Popen([sys.executable, "client.py", "--client_id", str(i)])
    ...
    malicious_client = subprocess.Popen([sys.executable, "client.py", "--client_id", "3", "--malicious"])
